...
import com.indu.repository.ProjectRepository;
...
public class ProjectServiceImpl implements ProjectService {
	...
	public Project createProject(Project project,Long id) throws UserException  {
    	System.out.println("enteredinservice");
		User user = userService.findUserById(id);
		System.out.println("enteredinservice1");
		Project createdProject=new Project();
		System.out.println("enteredinservice2");
